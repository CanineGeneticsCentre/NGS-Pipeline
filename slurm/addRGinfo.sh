...
INPUT=${SAMPLE}.s_${SLURM_ARRAY_TASK_ID}.aligned.bam 
OUTPUT=${SAMPLE}.s_${SLURM_ARRAY_TASK_ID}_aligned_sorted_rg.bam 
RGID=${BARCODE}.${SLURM_ARRAY_TASK_ID} 
RGLB=${SAMPLE} 
RGPL=${PLATFORM} 
RGPU=${BARCODE}.${SLURM_ARRAY_TASK_ID} 
RGSM=${SAMPLE} 
